...
export default function SciFiPage() {
  ...
  async function getMovies(pageNumber) {
    try {
      ...
      console.error("Sci-Fi movie fetch error:", error);
    } finally {
      setLoading(false);
    }
  }
    ...
    <main className="genre-page">
      <section className="genre-hero">
        <div className="genre-hero-content">
          ...
          <h1>Sci-Fi Movies</h1>
          <p>
            Explore futuristic worlds, advanced technology, space adventures
            and incredible science-fiction stories.
          </p>
        </div>
      </section>
      ...
      <section className="movie-section">
        <div className="section-heading">
          <h2>Sci-Fi Movies</h2>
          <p>Popular science-fiction movies from TMDB</p>
        </div>
